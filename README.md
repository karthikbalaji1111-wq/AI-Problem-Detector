...
**One-line concept:** It is a prevention-first, multi-agent intelligence platform that continuously observes authorized digital signals, detects weak signals of emerging problems, explains why they matter, and coordinates safe human-approved action before a crisis becomes visible.
...
## 1. Product Vision
 ...
 makes organizations and individuals feel like they have a calm, vigilant intelligence layer watching the horizon.
...
Open the web app at `http://localhost:3000` and the API at `http://localhost:8000`.
